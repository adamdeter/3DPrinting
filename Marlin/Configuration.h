...
#define STRING_CONFIG_H_AUTHOR "(DeterCustoms, Ender5plus_btt-skr-mini-e3-v3_BLTouch)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -10, -2.8 }
